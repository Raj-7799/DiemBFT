...
class LeaderElection:
    ...
    def elect_reputation_leaders(self, qc):
        diem_logger.debug("[replicaID {}] START qc.vote_info.roundNo {}".format(self.replicaID,qc.vote_info.roundNo))
        ...
        diem_logger.debug("[replicaID {}] END qc.vote_info.roundNo {}".format(self.replicaID,qc.vote_info.roundNo))
        return active_validators[random.randint(0, len(active_validators) - 1)]

        
    def update_leaders(self, qc):
        diem_logger.debug("[replicaID {}] START qc.vote_info.roundNo {} self.paceMaker.current_round {}".format(self.replicaID, qc.vote_info.roundNo, self.paceMaker.current_round))
    ...
    def get_leader(self, roundNo):
        diem_logger.debug("[replicaID {}] START roundNo {} self.paceMaker.current_round {}".format(self.replicaID,roundNo, self.paceMaker.current_round))
        ...
        diem_logger.debug("[replicaID {}] END roundNo {} self.paceMaker.current_round {}".format(self.replicaID, roundNo, self.paceMaker.current_round))
